        ...
        <div className="about_description_single">
          <div style={{ backgroundColor: '#f5f5ff', padding: '20px', borderRadius: '4px' }}>
            ...
            <p>
              ...
              Residential Nepali Association - Global's Website, located at https://nrnaglobal.com.
            </p>

            <p>
              By accessing this website we assume you accept these terms and conditions. Do not
              continue to use NRNA Global if you do not agree to take all of the terms and
            ...
            <p>
              ...
              in accordance with and subject to, prevailing law of np. Any use of the above
            ...
            <p>
              We employ the use of cookies. By accessing NRNA Global, you agreed to use cookies in
              agreement with the Non Residential Nepali Association - Global's Privacy Policy.{' '}
            </p>
            ...
            <p>
              Unless otherwise stated, Non Residential Nepali Association - Global and/or its
              licensors own the intellectual property rights for all material on NRNA Global. All
              intellectual property rights are reserved. You may access this from NRNA Global for
              your own personal use subjected to restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from NRNA Global</li>
              <li>Sell, rent or sub-license material from NRNA Global</li>
              <li>Reproduce, duplicate or copy material from NRNA Global</li>
              <li>Redistribute content from NRNA Global</li>
            </ul>
            ...
            <p>
              ...
              information in certain areas of the website. Non Residential Nepali Association -
              Global does not filter, edit, publish or review Comments prior to their presence on
              the website. Comments do not reflect the views and opinions of Non Residential Nepali
              Association - Global,its agents and/or affiliates. Comments reflect the views and
              opinions of the person who post their views and opinions. To the extent permitted by
              applicable laws, Non Residential Nepali Association - Global shall not be liable for
            ...
            <p>
              Non Residential Nepali Association - Global reserves the right to monitor all Comments
            ...
            <p>
              You hereby grant Non Residential Nepali Association - Global a non-exclusive license
              to use, reproduce, edit and authorize others to use, reproduce and edit any of your
            ...
            <p>
              ...
              from the visibility of the hyperlink compensates the absence of Non Residential Nepali
              Association - Global; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              linking to our website, you must inform us by sending an e-mail to Non Residential
              Nepali Association - Global. Please include your name, your organization name, contact
            ...
            <p>
              No use of Non Residential Nepali Association - Global's logo or other artwork will be
