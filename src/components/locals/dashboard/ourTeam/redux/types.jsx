...
export const CHANGE_TEAMS_STATUS_BEGIN = 'CHANGE_TEAMS_STATUS_BEGIN';
export const CHANGE_TEAMS_STATUS_SUCCESS = 'CHANGE_TEAMS_STATUS_SUCCESS';
export const CHANGE_TEAMS_STATUS_ERROR = 'CHANGE_TEAMS_STATUS_ERROR';
